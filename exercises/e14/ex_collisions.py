...
if __name__ == "__main__":
    ...
    gravityAcceleration1 = np.array([-1.0, -1.0], dtype=np.float32)
    gravityAcceleration2 = np.array([-1.0, 1.0], dtype=np.float32)
    gravityAcceleration3 = np.array([1.0, 1.0], dtype=np.float32)
    gravityAcceleration4 = np.array([1.0, -1.0], dtype=np.float32)
            ...
            if controller.useGravity:
                if circle.position[0]>0:
                    if circle.position[1]>0:
                        acceleration = gravityAcceleration1
                    else:
                        acceleration = gravityAcceleration2
                else:
                    if circle.position[1]>0:
                        acceleration = gravityAcceleration4
                    else:
                        acceleration = gravityAcceleration3
